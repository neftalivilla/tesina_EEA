---
title: "Anexo - Código de R"
subtitle: "Tesina: Rendimiento pronóstico de subrogados clínicos para estimar la acumulación de tejido adiposo visceral en la predicción de mortalidad por causas cardiovasculares en participantes de la Cohorte de la Ciudad de México"
date: "8-Mayo-2023"
author: "Neftali Eduardo Antonio Villa"
format: pdf
editor: visual
---
...
```{r Importación de Datos, echo=TRUE, message=FALSE, warning=FALSE}
...
## Resultados: Capitulo 3 - Proceso de selección de participantes integrantes de la muestra de estudio

```{r}
#Se corrobora que no se tengan datos perdidos en los estimadores de adiposidad
#visceral
...
## Resultados: Capitulo 3 - Características descriptivas de la muestra de estudio
...
## Resultados: Capitulo 3 - Estimación de subrogados clínicos de adiposidad viscera
...
ggarrange(Sup.Fig.1A,Sup.Fig.1B,Sup.Fig.1C,Sup.Fig.1D,Sup.Fig.1E,Sup.Fig.1F,ncol = 3,nrow = 2,labels = LETTERS[1:6])

```

## Resultados: Capitulo 3 - Evaluación de causas de muerte cardiovascular
...
ggplot2::ggplot(df,aes(area=prevalence,
                       fill=CLUSTERS,
                       label=labels,
                       subgroup = hemisphere))+
...
## Resultados: Capitulo 3 - Resultados del modelaje de riesgos competitivos
...
## Resultados: Capitulo 3 - Métricas de calibración
...
ggarrange(Figure4A,Figure4B,Figure4C,ncol = 3,nrow = 1)


```

## Resultados: Capitulo 3 - Metricas de rendimiento general
...
ggarrange(Figure2A,Figure2B,Figure2C,Figure2D,ncol = 2,nrow = 2)

```

## Resultados: Capitulo 3 - Estimación del rendimiento pronóstico durante el tiempo de seguimiento
...
ggarrange(Figure3A,Figure3B,Figure3C,Figure3D,ncol = 2,nrow = 2,labels = LETTERS[1:4])

```

## Resultados: Capitulo 3 - Evaluación de puntos de corte específicos
...
flextable::align(flextable::flextable(df.cut,cwidth=7),align="center",part="all")%>%flextable::autofit()
```
